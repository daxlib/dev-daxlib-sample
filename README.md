# `DaxLib.Sample` Development Repository

This is the official development repository for the [**DaxLib.Sample**](https://daxlib.org/package/DaxLib.Sample/) library.

## About

The library is officially distributed via [daxlib.org](https://daxlib.org/package/DaxLib.Sample/), which is the recommended and supported way to consume it.
